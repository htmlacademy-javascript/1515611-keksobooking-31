...
const deactivateAdForm = () => {
  ...
  adElements.forEach((elem) => { elem.setAttribute('disabled', '') });
...
const activateAdForm = () => {
  ...
  adElements.forEach((elem) => { elem.removeAttribute('disabled') })
}

const deactivateFilterForm = () => {
  filterForm.classList.add('filter-form--disabled');
  mapFilters.forEach((elem) => { elem.setAttribute('disabled', '') });
...
const activateFilterForm = () => {
  ...
  mapFilters.forEach((elem) => { elem.removeAttribute('disabled') });
...
export { activateAdForm, deactivateAdForm, activateFilterForm, deactivateFilterForm };
